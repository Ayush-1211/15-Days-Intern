            ...
            <div id="content">
                ...
                <div class="container">
                    <form action="reg_action.php" method="post">
                        ...
                        <label>Address</label>
                        <textarea id="address" name="address" placeholder="Write your address here...." style="height:200px"></textarea>
                        </br></br>
                        <label>Email</label>
                        <input id="email" name="email" placeholder="Write your email here...."></input>
                        </br></br>
